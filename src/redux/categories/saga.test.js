...
import {startGetCategoryItems,successGetCategoriesItem,failedGetCategoriesItem} from './actions'
...
describe('sagas',()=>{
    it('should load categories item success',()=>{
        ...
        expect(generator.next().value)
            .toEqual(call(getCategoryItems,{id:7,limit:10}));
        expect(generator.next(response).value)
            .toEqual(put(successGetCategoriesItem(response)));
    ...
    it('failure triggers failure action', () => {
        ...
        expect(generator.throw(response).value)
            .toEqual(put(failedGetCategoriesItem( response)));
